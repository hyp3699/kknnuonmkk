...
SCRIPT_URL="https://raw.githubusercontent.com/hyp3699/kknnuonmkk/main/extended-vps/central-vps.sh"
PORT=18089
AGENT_URL="https://raw.githubusercontent.com/hyp3699/kknnuonmkk/main/extended-vps/agent.sh"
...
' 2>/dev/null)
    ...
    printf '%s\n' "$short_path" > "$temp_dir/short_path"
...
[Service]
Type=simple
ExecStart=/usr/bin/python3 $sub_service
Restart=always
RestartSec=3
User=root
