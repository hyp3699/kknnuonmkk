            ...
            if not token or not wg_key:
                ...
                self.send_json(
                    400,
                    {
                        "ok": False,
                        "error":
                            "missing token or wg_public_key"
                    }
                )
            ...
            if not endpoint:
                ...
                self.send_json(
                    500,
                    {
                        "ok": False,
                        "error":
                            "failed to get central public IPv4"
                    }
                )
...
delete_script() {
    ...
    rm -f \
        /etc/systemd/system/central-vps.service
